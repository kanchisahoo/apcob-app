                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        style={{
                            ...
                            backgroundColor:
                                selectedPaymentOption === 'IMPS' ? '#028A3B' : '#ffffff',
                        }}>
                        <Text
                            style={{
                                color: selectedPaymentOption === 'IMPS' ? '#ffffff' : '#8B0304',
                                fontSize: 14,
                                fontWeight: '400',
                                textAlign: 'center',
                            }}>
                    ...
                    <TouchableOpacity
                        ...
                        style={{
                            ...
                            justifyContent: 'space-evenly',
                            backgroundColor:
                                selectedPaymentOption === 'NEFT' ? '#028A3B' : '#ffffff',
                        }}>
                        <Text
                            style={{
                                color: selectedPaymentOption === 'NEFT' ? '#ffffff' : '#028A3B',
                                fontSize: 14,
                                textAlign: 'center',
                            }}>
                            NEFT
